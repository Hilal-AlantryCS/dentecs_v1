...
import 'package:dentecs_v1/controller/organise_controller.dart';
import 'package:dentecs_v1/data/datasource/static/static.dart';
import 'package:dentecs_v1/widget/CustomDrawer.dart';

// ignore: must_be_immutable, camel_case_types
class Organise_view extends StatelessWidget {
  Organise_view({super.key});

  // ignore: non_constant_identifier_names
  Organise_Controller O_Conroller = Get.put(Organise_Controller());
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: ListView(children: [
          ...
          GetBuilder<Organise_Controller>(builder: (oConroller) {
            return Column(
              children: [
                SizedBox(
                    ...
                    children: [
                          ...
                          child: Padding(
                              ...
                              child: ListView(
                                children: [
                                  ...
                                  Text(organiseList[oConroller.current].body!)
                                ],
                              )),
                        )),
                      ),
                      Positioned(
                        ...
                        child: Center(
                          ...
                          child: Center(
                              child: Text(
                            organiseList[oConroller.current].title!,
